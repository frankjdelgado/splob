            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="status">
                        ...
                        <form action="#" id="feed" method="POST">
                            <div class="bubble">
                                <div class="formWrapper">
                                    <div class="form-group">
                                        <textarea  class="form-control" name="content" id="" cols="30" rows="2" required></textarea>
                                    </div>
                                </div>
                        ...
                        <ul class="feeds">
                            ...
                            <li>
                                ...
                                <div class="feedContent">
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui, esse, voluptatem architecto excepturi alias iusto minus deserunt praesentium voluptatum aperiam optio vitae facere tempora eius autem veniam enim accusamus perferendis.</p>
                                    <div class="text-right">
                                        <a href="post.html">Ver más</a>
                                    </div>
                                </div>
                            </li>
                            <li>
                    ...
                    <div class="evento">
                        ...
                        <form action="#"  role="form" method="post" id="ev">
                            <div class="input-group">
                                ...
                                <input type="date" class="input-sm form-control" placeholder="Fecha Evento" required>
                            </div>
                            <div class="input-group">
                                <span class="input-group-addon icon-paragraph-left"></span>
                                <input type="text" class="input-sm form-control" placeholder="Título" required>
                            </div>
                            <div class="input-group">
                                <span class="input-group-addon icon-paperclip"></span>
                                <input type="file" class="input-sm form-control">
                            </div>
                            <div class="text-right">
